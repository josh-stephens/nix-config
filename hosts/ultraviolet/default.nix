...
{ inputs, outputs, lib, config, pkgs, ... }: {
  ...
  environment.etc."jellyfin/encoding.xml".text = ''
    <?xml version="1.0" encoding="utf-8"?>
    <EncodingOptions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
      <EncodingThreadCount>4</EncodingThreadCount>
      <EnableFallbackFont>true</EnableFallbackFont>
      ...
      <ThrottleDelaySeconds>120</ThrottleDelaySeconds>
      ...
      <EncoderAppPath>/run/current-system/sw/bin/ffmpeg</EncoderAppPath>
      <EncoderAppPathDisplay>/run/current-system/sw/bin/ffmpeg</EncoderAppPathDisplay>
  ...
  systemd.services.jellyfin = {
    environment = {
      ...
      LIBVA_DEBUG = "1";
      VAAPI_MPEG2_REQUEST = "true";
      VAAPI_VP8_REQUEST = "true";
      VAAPI_H264_REQUEST = "true";
      VAAPI_HEVC_REQUEST = "true";
    };
    serviceConfig = {
  ...
  # Ensure transcoding directories exist with correct permissions
  systemd.tmpfiles.rules = [
